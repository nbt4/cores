...
| KI-Abfragen und geführte Schreibzugriffe | Cores MCP | kuratierte Felder und Schema-Discovery; PostgreSQL READ ONLY; eng begrenzte Anlagen und P0/P1-Workflows nur per persönlichem OAuth, Live-Validierung, Vorschau und Bestätigung über Core-APIs; Warehouse-Produkt und ausdrücklich freigegebene Stammdaten entstehen atomar im WarehouseCore |
