...
CREATE UNIQUE INDEX IF NOT EXISTS uq_label_printers_default ON label_printers(is_default) WHERE is_default;
...
CREATE TABLE IF NOT EXISTS pdf_extraction_items (
    ...
    mapped_package_id   BIGINT REFERENCES product_packages(id) ON DELETE SET NULL,
...
CREATE TABLE IF NOT EXISTS pdf_package_mappings (
    ...
    normalized_text  TEXT,
    package_id       BIGINT REFERENCES product_packages(id) ON DELETE CASCADE,
    mapping_type     VARCHAR(20) DEFAULT 'fuzzy',
    confidence_score DECIMAL(5,2) DEFAULT 0,
    usage_count      INT DEFAULT 0,
    last_used_at     TIMESTAMP,
...
INSERT INTO label_templates (name, description, width, height, template_json, is_default, target_type, revision) VALUES
('Standard Geräte-Label', 'Geräte-Label 51x25mm', 51, 25, '[{"type":"qrcode","x":2,"y":2,"width":21,"height":21,"rotation":0,"content":"code","style":{"format":"qr"}},{"type":"text","x":25,"y":3,"width":24,"height":7,"rotation":0,"content":"product_name","style":{"font_size":9,"font_weight":"bold","font_family":"Arial","color":"#000000","alignment":"left"}},{"type":"text","x":25,"y":13,"width":24,"height":5,"rotation":0,"content":"device_id","style":{"font_size":8,"font_weight":"normal","font_family":"Arial","color":"#000000","alignment":"left"}}]', TRUE, 'device', 1),
('Standard Produkt-Label', 'Artikel- und Mengenlabel 51x25mm', 51, 25, '[{"type":"barcode","x":2,"y":2,"width":47,"height":11,"rotation":0,"content":"code","style":{"format":"code128"}},{"type":"text","x":2,"y":14,"width":47,"height":5,"rotation":0,"content":"name","style":{"font_size":9,"font_weight":"bold","font_family":"Arial","color":"#000000","alignment":"left"}},{"type":"text","x":2,"y":20,"width":47,"height":4,"rotation":0,"content":"code","style":{"font_size":7,"font_weight":"normal","font_family":"Arial","color":"#000000","alignment":"left"}}]', TRUE, 'product', 1),
('Standard Case-Label', 'Case-Label 51x25mm', 51, 25, '[{"type":"qrcode","x":2,"y":2,"width":21,"height":21,"rotation":0,"content":"code","style":{"format":"qr"}},{"type":"text","x":25,"y":4,"width":24,"height":7,"rotation":0,"content":"name","style":{"font_size":10,"font_weight":"bold","font_family":"Arial","color":"#000000","alignment":"left"}},{"type":"text","x":25,"y":14,"width":24,"height":5,"rotation":0,"content":"code","style":{"font_size":8,"font_weight":"normal","font_family":"Arial","color":"#000000","alignment":"left"}}]', TRUE, 'case', 1),
('Standard Zonen-Label', 'Lagerzonen-Label 62x29mm', 62, 29, '[{"type":"qrcode","x":2,"y":2,"width":25,"height":25,"rotation":0,"content":"code","style":{"format":"qr"}},{"type":"text","x":30,"y":4,"width":30,"height":8,"rotation":0,"content":"zone_code","style":{"font_size":14,"font_weight":"bold","font_family":"Arial","color":"#000000","alignment":"left"}},{"type":"text","x":30,"y":15,"width":30,"height":6,"rotation":0,"content":"name","style":{"font_size":9,"font_weight":"normal","font_family":"Arial","color":"#000000","alignment":"left"}}]', TRUE, 'zone', 1)
ON CONFLICT (name) DO NOTHING;
...
-- Device availability lifecycle: a closed job means return is due, not that
-- the equipment is automatically back at a warehouse location.
CREATE INDEX IF NOT EXISTS idx_job_devices_issued_device
    ON job_devices(deviceid, jobid)
    WHERE pack_status = 'issued';
...
VALUES ('038_device_status_lifecycle')
